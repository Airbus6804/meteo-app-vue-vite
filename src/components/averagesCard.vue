...
//const data = await meteo.getHourly() as meteoInformationsHourly;
...
//console.log(props.hourly.relative_humidity[0])

const data = props.hourly;
...
let averageHumidity: any = ref(0);
let averageTemperature: any = ref(0);
let averageRain: any = ref(0);
...
averageHumidity.value = totHumidity / 24;
averageTemperature.value = totTemperature / 24;
averageRain.value = totRain / 24;
...
<template>
  <section class="averagesCard">
    <average
      :icon="getIconName(faTemperature2)"
      :data="averageTemperature"
      name="Average Temp."></average>
    <average
      :icon="getIconName(faUmbrella)"
      :data="averageRain"
      name="Average Rain."></average>
    <average
      :icon="getIconName(faWater)"
      :data="averageHumidity"
      name="Average Humidity"></average>
  </section>
</template>
